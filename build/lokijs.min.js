(function(root, factory) {
  ...
  return function() {
    ...
    function Loki(filename, options) {
      ...
      this.verbose = options && Object.hasOwn(options, "verbose") ? options.verbose : false;
      this.events = {
        init: [],
        loaded: [],
        flushChanges: [],
    ...
    Loki.prototype.loadJSONObject = function(dbObject, options) {
      ...
      for (i; i < len; i += 1) {
        ...
        ) ? coll.adaptiveBinaryIndices === true : false;
    ...
    class Collection extends LokiEventEmitter {
      constructor(name, options) {
        ...
        this.adaptiveBinaryIndices = options.hasOwnProperty(
          "adaptiveBinaryIndices"
        ) ? options.adaptiveBinaryIndices : true;
        ...
        ) ? options.disableDeltaChangesApi : true;
        ...
        function observerCallback(changes) {
          const changedObjects = typeof Set === "function" ? /* @__PURE__ */ new Set() : [];
        ...
        function getObjectDelta(oldObject, newObject) {
          ...
          if (propertyNames && propertyNames.length && !["string", "boolean", "number"].includes(typeof newObject)) {
            const delta = {};
            for (let i = 0; i < propertyNames.length; i++) {
              const propertyName = propertyNames[i];
              if (newObject.hasOwnProperty(propertyName)) {
                if (!oldObject.hasOwnProperty(propertyName) || self.uniqueNames.includes(propertyName) || propertyName == "$loki" || propertyName == "meta") {
      ...
      insert(doc, overrideAdaptiveIndices) {
        ...
        let obj;
        let results = [];
        const adaptiveBatchOverride = overrideAdaptiveIndices && !this.cloneObjects && this.adaptiveBinaryIndices && Object.keys(this.binaryIndices).length > 0;
      ...
      removeBatchByPositions(positions) {
        ...
        const adaptiveOverride = this.adaptiveBinaryIndices && Object.keys(this.binaryIndices).length > 0;
        let doc;
        const self = this;
        try {
          this.startTransaction();
      ...
      adaptiveBinaryIndexInsert(dataPosition, binaryIndexName) {
        ...
        const idxPos = index.length === 0 ? 0 : this.calculateRangeStart(
          binaryIndexName,
          val,
          true,
          usingDotNotation
      ...
      by(field, value) {
        ...
        if (value === void 0) {
          self = this;
          return (value2) => self.by(field, value2);
        }
