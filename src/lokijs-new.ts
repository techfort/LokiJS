...
(function (root, factory) {
  ...
  return (function () {
    ...
    const Utils = {
      ...
      resolveTransformObject: function (
        subObj: object,
    ...
    const LokiOps = {
      ...
      $type: function (a, b, record) {
        let type: typeof a | "array" | "date" = typeof a;
        if (type === "object") {
          if (Array.isArray(a)) {
            type = "array";
     ...
     */
    function Loki(filename, options?: Record<string, any>) {
     ...
     */
    function Resultset(collection, options?: Record<string, any>) {
      options = options || {};
    ...
    Resultset.prototype.find = function (query, firstOnly) {
      ...
      // first chained query so work against data[] but put results in filteredrows
        ...
        if (!searchByIndex) {
          ...
          // search by index
          const segm = this.collection.calculateRange(
            operator,
            property,
            value
          );
    ...
    DynamicView.prototype._indexOfFilterWithId = function (uid) {
      if (typeof uid === "string" || typeof uid === "number") {
        for (
          let idx = 0, len = this.filterPipeline.length;
          idx < len;
          idx += 1
        ) {
     ...
     */
    function Collection(name: string, options?: Record<string, any>) {
